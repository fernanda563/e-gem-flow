...
const MOUNTING_STATUS = [
  ...
  { value: "en_proceso_vaciado", label: "En proceso de vaciado" },
  { value: "pieza_terminada_taller", label: "Pieza terminada en taller" },
  { value: "en_proceso_recoleccion", label: "En proceso de recolección" },
